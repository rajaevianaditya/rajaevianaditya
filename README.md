...
<p align="center">
  <a href="https://rajaaditya.my.id"><img alt="Portfolio" src="https://img.shields.io/badge/-Portfolio-000000?style=for-the-badge&logo=google-chrome&logoColor=white"></a>
  <a href="https://plugins.rajaaditya.my.id"><img alt="Plugin Store" src="https://img.shields.io/badge/-Plugin%20Store-FF6B00?style=for-the-badge&logo=shopify&logoColor=white"></a>
  <a href="https://docs.rajaaditya.my.id/"><img alt="Documentation" src="https://img.shields.io/badge/-Docs-3178C6?style=for-the-badge&logo=readthedocs&logoColor=white"></a>
...
|---|---|---|
| 🏰 **Arden Network** | Minecraft server network coin top-up store | [store.ardennetwork.net](https://store.ardennetwork.net/) |
| 🌸 **GoKaizen Community** | Community coin top-up store | [store.gokaizencommunity.com](https://store.gokaizencommunity.com/) |

---

### 🧩 Premium Minecraft Plugins (RA- Series)

📖 Full plugin documentation available at **[docs.rajaaditya.my.id](https://docs.rajaaditya.my.id/)**

| Plugin | Description |
|---|---|
| 💰 **RA-CoinsEconomy** | Core economy backend used across the RA- plugin ecosystem |
| 🎟️ **RA-Battlepass** | Full battlepass system with quests & dual reward tracks |
| 🖱️ **RA-ExcellentMenus** | Advanced GUI menu system with JS scripting support |
| 🏷️ **RA-TagSystem** | Permission-based player tag system with GUI |
| 🔥 **RA-StreakSystem** | Daily login streaks with friend streak pairs |
| 🎣 **RA-FishingEvent** | Custom fishing event with rarities & weighted rolls |
| 🚤 **RA-RaceBoatEvent** | Boat racing event with checkpoint detection |
| 🧾 **RA-TaxSystem** | Daily wealth tax on Vault & bank balances |

👉 Explore all plugins at **[plugins.rajaaditya.my.id](https://plugins.rajaaditya.my.id)**
...
- 🏰 **Arden Network** — Minecraft server network with custom coin store, Discord AI bot, and tiered auto-moderation
- 🖱️ **eMenus Web Companion** — Next.js app for visually editing GUI menu configs with Bedrock preview
- 🛒 **Plugin Marketplace** — Next.js site with license key management & Redis caching
- 🤖 **WhatsApp AI Bot** — Baileys-based bot with persistent chat history & multimodal image support
